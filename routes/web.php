...
use App\Http\Controllers\ConsultationController; // Ditambahkan
use App\Http\Controllers\PaymentController; // Ditambahkan
use App\Http\Controllers\Psychologist\AvailabilityController; // Ditambahkan
use App\Http\Controllers\Psychologist\ProfileController as PsychologistProfileController; // Ditambahkan
use App\Http\Controllers\DailyDiaryController; // Ditambahkan
