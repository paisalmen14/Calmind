                    ...
                    <div class="p-4 border rounded-lg bg-gray-50">
                        ...
                        <div class="mt-4 flex items-center space-x-4">
                            ...
                            <form action="{{ route('admin.consultation.verifications.reject', $consultation) }}" method="POST" class="inline">
                                @csrf
                                <input type="text" name="rejection_reason" placeholder="Alasan Penolakan (wajib diisi)" class="text-sm rounded-md border-gray-300 focus:ring-brand-pink focus:border-brand-pink">
