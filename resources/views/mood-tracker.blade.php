<x-app-layout>
  <x-slot name="header">
    {{-- Teks header sudah diperbaiki warnanya untuk mode gelap --}}
        ...
        <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
          ...
          <div class="flex flex-col items-center">
            <div class="relative w-full max-w-lg">
              <video id="video-preview" width="640" height="480" autoplay muted class="rounded-lg shadow-md bg-gray-900 border-2 border-gray-700"></video>
            ...
            <div class="mt-6 flex space-x-4">
              ...
              <button id="capture-btn" disabled class="flex items-center px-6 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 disabled:opacity-50 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
  ...
  <script>
    ...
    const moodAnalysisData = {
      'senang': {
        ...
        activities: [
          'Tulis tiga hal yang membuat Anda bersyukur hari ini di diary.',
          'Lakukan kebaikan kecil untuk orang lain, seperti memberi pujian.',
          'Salurkan energi kreatif Anda: menggambar, menari, atau bernyanyi.'
        ]
      },
      'sedih': {
        emoji: '😢',
        ...
        activities: [
          'Lakukan aktivitas yang menenangkan seperti mandi air hangat atau minum teh herbal.',
          'Tonton film atau dengarkan lagu yang bisa membuat Anda merasa lebih baik.',
          'Hubungi teman dekat atau anggota keluarga untuk sekadar berbagi cerita.'
        ]
      },
      'marah': {
        emoji: '😠',
        ...
        activities: [
          'Lakukan aktivitas fisik seperti lari cepat, workout, atau memukul bantal untuk melepaskan ketegangan.',
          'Tulis semua yang membuat Anda marah di secarik kertas, lalu robek kertas itu.',
          'Praktikkan teknik pernapasan 4-7-8: tarik napas 4 detik, tahan 7 detik, hembuskan 8 detik.'
        ]
      },
      'netral': {
        emoji: '😐',
        ...
        activities: [
          'Buat daftar tugas (to-do list) untuk esok hari agar lebih terorganisir.',
          'Pelajari skill atau baca topik baru yang menarik minat Anda.',
          'Lakukan meditasi body scan untuk lebih terhubung dengan kondisi tubuh Anda.'
        ]
      },
      'terkejut': {
        emoji: '😮',
        ...
        activities: [
          'Duduk atau berdiri diam, rasakan pijakan kaki Anda di lantai untuk grounding.',
          'Jelaskan kejadian tersebut kepada diri sendiri atau orang lain untuk membuatnya lebih masuk akal.',
          'Alihkan fokus sejenak ke aktivitas rutin yang sederhana, seperti menyeduh teh.'
        ]
      },
      'takut': {
        emoji: '😨',
        ...
        activities: [
          'Terapkan teknik grounding 5-4-3-2-1: sebutkan 5 benda yang Anda lihat, 4 benda yang Anda sentuh, 3 suara yang Anda dengar, 2 bau yang Anda cium, dan 1 rasa yang bisa Anda kecap.',
          'Genggam es batu atau basuh wajah dengan air dingin untuk "mengejutkan" sistem saraf Anda agar kembali tenang.',
          'Dengarkan musik instrumental yang menenangkan atau suara alam.'
        ]
      },
      'jijik': {
        emoji: '🤢',
        ...
        activities: [
          'Ciptakan lingkungan yang menyenangkan secara sensorik: nyalakan lilin aroma terapi atau putar musik yang Anda suka.',
          'Lakukan aktivitas bersih-bersih atau merapikan sesuatu untuk mendapatkan kembali rasa kontrol.',
          'Fokus pada hobi atau aktivitas yang Anda nikmati untuk menggantikan perasaan negatif.'
        ]
      }
    };
    ...
    startCameraBtn.addEventListener('click', async () => {
      try {
        ...
        startCameraBtn.classList.add('hidden'); // Sembunyikan tombol setelah kamera aktif
      } catch (err) {
        ...
        fetch(detectUrl, {
          ...
          .then(data => {
            if (data.success) {
              ...
              alert('Gagal mendeteksi emosi. Silakan coba lagi.');
            }
          })
          .catch(error => {
