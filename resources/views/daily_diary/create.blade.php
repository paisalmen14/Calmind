                ...
                <form action="{{ route('daily-diary.store') }}" method="POST">
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full bg-slate-50 border-gray-300 rounded-lg shadow-sm focus:border-brand-pink focus:ring-brand-pink" :value="old('title')" required autofocus />
                            @error('title')
