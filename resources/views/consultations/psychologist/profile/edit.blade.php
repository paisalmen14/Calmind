    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
        <form method="POST" action="{{ route('psychologist.profile.update') }}" enctype="multipart/form-data">
            ...
            <div class="p-6 md:p-8 space-y-8">
                ...
                {{-- Bagian Spesialisasi --}}
                <div class="border-t pt-8">
                    <x-input-label for="specialization" value="Spesialisasi" class="text-base font-semibold text-gray-900" />
                    <p class="text-sm text-gray-500 mt-1">Contoh: Psikolog Klinis, Konselor Pernikahan.</p>
                    <input id="specialization" name="specialization" type="text" class="{{ $inputClasses }}" value="{{ old('specialization', $profile->specialization) }}" />
